import tkinter as tk     #importing required package from internet    #tkinter is used to develop GUI application
from tkinter import *
...
# Database            # importing required database system      
import sqlite3
import csv


conn = sqlite3.connect('data.db')     # defining sql connect
c = conn.cursor()

def create_table():   # defining func
...
label1 = Label(tab1, text= 'Student Registration Form',padx=5, pady=5)
...
def add_details():
	...
	messagebox.showinfo(title = "Student Registration Form ", message = "Submitted to DataBase")
...
def export_as_csv():
	...
	with open(myfilename, 'w') as f:
	    ...
	    messagebox.showinfo(title = "Student Registration Form", message = '"Exported As {}"'.format(myfilename))
...
button1 = Button(tab1,text="Clear",width=12,bg='#03A9F4',fg='#800000',command=clear_text)
button1.grid(row=8,column=0,padx=10,pady=10)


button2 = Button(tab1,text="Add",width=12,bg='#03A9F4',fg='#800000',command=add_details)
...
button3 = Button(tab1,text="Clear Result",width=12,bg='#03A9F4',fg='#800000',command=clear_display_result)
...
button_view2 = Button(tab2,text="View All",width=12,bg='#03A9F4',fg='#800000',command=view_all_users)
...
tree.heading("#3", text="")                                  ## stacking concept one by one ordering using tree method 
tree.heading("#1", text="First Name")
tree.heading("#2", text="Las Name")
tree.heading("#3", text="Mail ID")
...
label_view1.grid(column=0,row=1)                                                          #static label
search_raw_entry = StringVar()
...
button_view3 = Button(tab3,text="Clear Search",width=12,bg='#03A9F4',fg='#800000',command=clear_entered_search)
button_view3.grid(row=2,column=1,padx=10,pady=10)

button_view4 = Button(tab3,text="Clear Results",width=12,bg='#03A9F4',fg='#800000',command=clear_display_view)
button_view4.grid(row=2,column=2,padx=10,pady=10)

button_view5 = Button(tab3,text="Search",width=12,bg='#03A9F4',fg='#800000',command=search_user_by_name)
...
button_export3 = Button(tab5,text="To CSV",width=12,bg='#03A9F4',fg='#800000',command=export_as_csv)
button_export3.grid(row=3,column=1,padx=10,pady=10)

button_export3 = Button(tab5,text="To XLS",width=12,bg='#03A9F4',fg='#800000',command=export_as_xls)
...
# About TAB
about_label = Label(tab6,text="This is a student Registration form",pady=5,padx=5)
about_label.grid(column=0,row=1)



window.mainloop()   # main loop without this code cantbprogessed 
